...
main: main.cpp paddle.o entity.o ball.o shader.o player.o bounding-box.o src/vertex.h
	${COMPILER} -o ${EXECUTABLE_NAME} main.cpp *.o -static-libstdc++ -static-libgcc ${INCLUDE_PATH} ${FLAGS} ${LIBPATH} ${LIBRARIES}
